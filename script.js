...
(function () {
  ...
  const TOOLS = [
    ...
    { id: 'split-workbook', name: 'Split Workbook', category: 'excel', icon: 'fa-scissors', desc: 'Break a large workbook into separate files by sheet, tab, or custom range.', dateAdded: 9 },
